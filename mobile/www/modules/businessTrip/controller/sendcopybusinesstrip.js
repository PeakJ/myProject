 ...
 * 知会我的出差
 */
bomApp.controller('sendCopyCtrl',['$scope','ListServices','userService','$state','planData','common'
    ...
    function($scope,ListServices,userService,$state,planData,common,$ionicScrollDelegate,loadingUtil){
        ...
        $scope.load_more = function(){
            loadingUtil.show();
            var parameter = "userId="+''+"&pageNo="+pageNo+"&pageSize="+common.pageSize();
       ...
       /* $scope.addBtu = function(){
        ...
        $scope.detail = function(businessTripId){
            ...
            $state.go('tellMeBusinessTripApproval',{businessTripId : businessTripId})
        };
        /*返回上一页*/
